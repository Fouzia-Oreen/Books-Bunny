...
import { audiobook } from "../../assets/data";
  ...
  return (  
    <div className="py-16">
      ...
      <div className='mt-36 flex gap-4 flex-col md:mt-0 items-center '>
          ...
          <h1 className='text-xl font-bold text-color_1'>Install Our App</h1>
          <p className='text-sm text-center text-color_1'>Listen to your favorite books in audio format.</p>
          </div>
